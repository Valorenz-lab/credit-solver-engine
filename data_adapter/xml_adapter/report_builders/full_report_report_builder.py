...
from data_adapter.xml_adapter.report_builders.bank_account_report_builder import (
...
from data_adapter.xml_adapter.report_builders.checking_account_report_builder import (
    CheckingAccountReportBuilder,
)
from data_adapter.xml_adapter.report_builders.credit_card_report_builder import (
    CreditCardReportBuilder,
)
from data_adapter.xml_adapter.report_builders.global_debt_builder import (
    GlobalDebtBuilder,
)
from data_adapter.xml_adapter.report_builders.global_report_report_builder import (
    GlobalReportBuilder,
)
from data_adapter.xml_adapter.report_builders.micro_credit_builder import (
    MicroCreditBuilder,
)
from data_adapter.xml_adapter.report_builders.query_builder import QueryBuilder
from data_adapter.xml_adapter.report_builders.score_alert_builder import (
    AlertBuilder,
    ScoreBuilder,
)
...
class FullReportBuilder:
    ...
    def _build(self, ex: XmlExtractor) -> FullReport:
        ...
        basic_data: BasicReport = BasicDataReportBuilder().build_from_node(
            ex, report_node
        )
        global_report: GlobalReport = GlobalReportBuilder().build_from_node(
            ex, report_node
        )
        ...
        return FullReport(
            ...
            checking_accounts=CheckingAccountReportBuilder().parse_accounts(
                ex, report_node
            ),
